...
namespace TheBugTracker.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> AllTickets()
        {
            ...
            if(User.IsInRole(nameof(Roles.Developer)) || User.IsInRole(nameof(Roles.Developer)))
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddTicketCommentAsync(TicketComment ticketComment)
        {
            if(ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> AddTicketAttachment([Bind("Id,FormFile,Description,TicketId")] TicketAttachment ticketAttachment)
        {
            ...
            if (ModelState.IsValid && ticketAttachment.FormFile != null)
            {
                ...
                ticketAttachment.UserId = Convert.ToInt32(_userManager.GetUserId(User));

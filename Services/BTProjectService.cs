...
namespace TheBugTracker.Services
{
    public class BTProjectService : IBTProjectService
    {
        ...
        public BTProjectService(ApplicationDbContext context, UserManager<BTUser> userManager, RoleManager<IdentityUser> roleManager, IBTRolesService rolesService)
        {
            _context = context;
        ...
        public async Task<bool> AddProjectManagerAsync(string userId, int projectId)
        {
            ...
            if (currentPM != null)
            {
                ...
                {
                    Console.WriteLine($"Error removing the current project manager. --> Error: {ex.Message}");
                }
            }
            ...
            {
                Console.WriteLine($"Error adding new project manager. --> Error: {ex.Message}");
                return false;
            }
